...
function Play_Dice() {
  ...
  if (sum == 11) {
    ...
    element_info.innerText = 'Winner chicken DINNER';
  } else if (sum > 11) {
    let element_info2 = document.getElementById('info');
    element_info2.innerText = 'lost, NO chicken DINNER';
  } else {
    let element_info3 = document.getElementById('info');
    element_info3.innerText = 'Still in game';
  }
}
...
document.getElementById('button_restart').addEventListener('click', (event) => {
  ...
  element_info4.innerText = 'Still in game';
